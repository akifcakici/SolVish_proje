...
public class SicakIceceklerEkrani extends JFrame {
    ...
    private void ekranOlustur() {
        ...
        for (JButton btn : new JButton[]{kahvaltiBtn, sogukIceceklerBtn, siparisButton, geriButton}) {
            stilVerButon(btn);
