...
public class KahvaltiEkrani extends JFrame {
    ...
    public KahvaltiEkrani() {
        setTitle("Kahvaltı Menüsü");
        setSize(600, 700);
    ...
    private void ekranOlustur() {
        ...
        JLabel baslikLabel = new JLabel("☕ Kahvaltı Menüsü");
        ...
        for (Urun urun : siparisYoneticisi.getKahvaltiUrunleri()) {
        ...
        for (JButton btn : new JButton[]{sicakIceceklerBtn, sogukIceceklerBtn, siparisButton, geriButton}) {
            stilVerButon(btn);
        ...
        sogukIceceklerBtn.addActionListener(e -> {
            new SogukIceceklerEkrani().setVisible(true);
            dispose();
        });
